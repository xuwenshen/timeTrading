...
@WebServlet("/CheckAccepted")
public class CheckAccepted  extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (username.equals(null)){
        	...
        	System.out.println("CheckAccepted " + username);
        }
        ...
        try {
        	System.out.println("CheckAccepted Before");
            ArrayList<Order> orders = orderDAOProxy.SelectAccepted(user);
        	...
        	System.out.println("CheckAccepted " + starttimes.toString());
        	req.setAttribute("username", username);
        	req.getRequestDispatcher("/src/HelpHistory.jsp").forward(req, resp);
        	return ;
